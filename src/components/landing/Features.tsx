...
const FEATURES = [
  ...
  {
    icon: '🐦',
    tag: 'Exclusive to Solscope',
    title: 'Launch from a tweet',
    description:
      'Spot a hot tweet about a new token? Trade it directly from the Solscope application. No copy-pasting, no tab switching.',
  },
  {
    icon: '🔐',
    tag: 'Privy-secured',
    ...
    description:
      'Sign in with Google — Solscope creates a non-custodial embedded wallet automatically. We never hold your funds.',
  },
];
